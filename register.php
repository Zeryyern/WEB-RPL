  ...
  <div class="card shadow p-4 w-100" style="max-width: 450px;">
    ...
    <form action="php/register.php" method="POST" autocomplete="off">
      <div class="mb-3 icon-input">
        ...
        <input type="text" class="form-control" id="name" name="fullname" placeholder="Your full name" required>
      </div>
      <div class="mb-3 icon-input">
      ...
      <div class="mb-3 icon-input">
        ...
        <input type="email" class="form-control" id="reg-email" name="email" placeholder="Your email" required>
      </div>
      <div class="mb-3 icon-input">
